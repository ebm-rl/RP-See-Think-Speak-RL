...
* **CLIP-MAX Method**: Replace the reward calculation script with [`src/r1-v/src/open_r1/clip_MAX_server.py`](.src/r1-v/src/open_r1/clip_MAX_server.py).

* **CLIP-SentTopK Method**: Replace the reward calculation script with [`src/r1-v/src/open_r1/clip_Topk_server.py`](.src/r1-v/src/open_r1/clip_Topk_server.py).
