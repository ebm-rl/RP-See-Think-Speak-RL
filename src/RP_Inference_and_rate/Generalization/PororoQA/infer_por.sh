...
export QWEN_VL_VIDEO_READER_BACKEND="torchvision"
set -u

MODEL_PATH="./Models/Qwen2.5-VL-7B-Instruct"
BASE_MODEL_PATH=""
INPUT_FILE="./src/RP_Inference_and_rate/Generalization/PororoQA/qa_subset.json" 
OUTPUT_FILE="./src/RP_Inference_and_rate/Generalization/PororoQA/infer_result/PororoQA_Inference-7b-instruct-2000.json"
MODE="normal_cot" 
SCRIPT_PATH="./src/RP_Inference_and_rate/Generalization/PororoQA/infer_new.py"
SAMPLE_SIZE=2000
SAMPLE_SEED=42
