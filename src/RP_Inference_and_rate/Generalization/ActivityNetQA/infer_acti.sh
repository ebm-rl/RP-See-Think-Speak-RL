...
BASE_MODEL_PATH=""
INPUT_FILE="./src/RP_Inference_and_rate/Generalization/ActivityNetQA/yes_no_subset.json" 
OUTPUT_FILE="./src/RP_Inference_and_rate/Generalization/ActivityNetQA/infer_result/ActivityNet-QA_Inference-7b-instruct.json"
MODE="normal_cot" 
SCRIPT_PATH="./src/RP_Inference_and_rate/Generalization/ActivityNetQA/infer_activity.py"
SAMPLE_SIZE=1000
SAMPLE_SEED=42
