...
MODEL_PATH="./src/r1-v/log/Qwen2.5-VL-7B-Rolae-Playing-GRPO-EBM-w-0.8-0.8"  # model checkpoint path
# BASE_MODEL_PATH="./Qwen2.5-VL-7B-Instruct" 
BASE_MODEL_PATH=""
INPUT_FILE="../simple-subtitling/Processed_Dialogue/RP-EBM-Dataset/RP-EBM-test.json"  # test dataset path
OUTPUT_FILE="./src/RP_Inference_and_rate/Inference_result/EBM-RL-infer-result.json" 
MODE="ours"
SCRIPT_PATH="./src/RP_Inference_and_rate/inference_model_on_EBM_prompt.py" 
